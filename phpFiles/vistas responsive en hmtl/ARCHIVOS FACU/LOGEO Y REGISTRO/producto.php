    ...
    <main>
        <div class="product-container">
            ...
            <div class="product-details">
                ...
                <p><strong>Stock (Alquiler):</strong> <?php echo htmlspecialchars($producto['stockAlquiler']); ?></p>
                ...
                <p><strong>Precio Alquiler:</strong> AR$ <?php echo number_format($producto['PrecioAlquiler'], 0, ',', '.'); ?></p>
